    ...
    public class ConcurrentFileStream : Stream, IDisposable
    {
        ...
        public override long Length
        {
            get
            {
                ...
                //return _readStream.Length < _writeStream.Length ? _readStream.Length : _writeStream.Length; //  _writePosition hat nicht funktioniert!
            }
        }
        ...
        /// 
        /// </summary>
        /// <param name="buffer">Kommt zurück mit den Daten</param>
        /// <param name="offset">Position</param>
        /// <param name="count">Wie viele bytes</param>
        /// <returns></returns>
        ...
        /// 
        /// </summary>
        /// <param name="buffer">Das was zu schreiben ist</param>
        /// <param name="offset">Position</param>
        /// <param name="count">Wie viele bytes</param>
